...
class BybitApi:
    ...
    def get_kline_info(self, symbol="BTCUSDT", interval=1, limit=2, from_time=1581231260) -> dict:
        data = self.api.query_kline(symbol=symbol, interval=interval, limit=limit, from_time=from_time)
        return data
